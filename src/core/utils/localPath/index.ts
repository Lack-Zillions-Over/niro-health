...
import { LocalPath as Types } from '@/core/utils/localPath/types';

@Injectable()
export class LocalPath implements Types.Class {
  /**
  ...
  public local(p: string): string {
    ...
    const base = dirname(String(__dirname)).replace('core/utils', '');
